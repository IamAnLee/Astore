            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all_category_product')}}">Tất cả danh mục sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add_brand_product')}}">Thêm thương hiệu</a></li>
						<li><a href="{{URL::to('/all_brand_product')}}">Tất cả thương hiệu</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all_product')}}">Tất cả sản phẩm</a></li>
                    </ul>
                </li>
