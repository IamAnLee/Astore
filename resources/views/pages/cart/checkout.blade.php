                    ...
                    <div class="resp-tabs-container">
                        ...
                        <div class="tab1">
                            <div class="pay_info">
                                ...
                                <br>
                                <form action="{{URL::to('/address')}}" method="post" class="creditly-card-form agileinfo_form">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="information-wrapper">
                                            <div class="first-row form-group">
                                                <div class="controls">
                                                    ...
                                                    <input class="billing-address-name form-control" type="text" name="full_name" placeholder="Họ và tên">
                                                </div>
                                                <?php $data=Session::get('customer_id');?>
                                                ...
                                                <div class="card_number_grids">
                                                    ...
                                                    <div class="card_number_grid_right">
                                                        <div class="controls">
                                                            ...
                                                            <input class="form-control" name="address" type="text" placeholder="Địa chỉ giao hàng">
                                                        </div>
                                                    </div>
                                                    <div class="clear"> </div>
                                                </div>
                                                <div class="controls">
                                                    <label class="control-label">Ghi chú cho đơn hàng: </label>
                                                    <textarea name="order_note" class="form-control" placeholder="Bạn có yêu cầu gì khi gửi hàng xin ghi chú vào đây" rows="7"></textarea>
                                                </div>
                                                {{-- <div class="controls">
